...
<body class="bg-fondoRegistro max-h-screen max-w-screen bg-cover bg-center flex flex-col min-h-screen">
    ...
    <main class=" flex flex-grow items-center justify-center  bg-cover">
        ...
        -->
            <form action="guardarregistro2.php" method="post" class="flex  h-fit w-80 select-none m-2" onsubmit="return validarFormulario();">
                <div class="w-96 p-6 shadow-lg bg-white rounded-md   ">
                    <h4 class="text-3xl block text-center font-bold text-gray-900">
                        Datos personales
                    </h4>
                    <div class="mt-3">
                        <label for="CURP" class="block text-base mb-1">Usuario</label>
                    ...
                    <div class="mt-3">
                        ...
                        <input type="password" id="password" name="password" class="w-full input-prymary" placeholder="Contraseña..." required/>
                    </div>
                    <div class="mt-3">
                        <label for="password" class="block text-base mb-1">Contraseña</label>
                        <input type="passwordCon" id="passwordCon" class="w-full input-prymary" placeholder="Contraseña..."required />
                    </div>

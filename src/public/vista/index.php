...
<body class="flex flex-col min-h-screen" >
    ...
    <main class="flex flex-grow">
        ...
        <article  id="devblog"class=" bg-cover bg-center rounded-r-lg   flex flex-initial w-4/6 " style="background-image:url(../../img/fondo.png) ;">
        ...
        <section class=" flex flex-auto justify-center items-center bg-current bg-white bg-bottom bg-no-repeat  " style="background-image:url(../../img/wave.svg) ;">
            <form action="../validar.php" method="post" class="flex  h-fit w-80 select-none">
                <div class="w-96 p-6 shadow-lg bg-stone-50 rounded-md   ">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" id="username" name="username" class="  input-prymary w-full" placeholder="Usuario..." />
                    </div>
                    <div class="mt-3">
                        <label for="password" class="block text-base mb-2">Contraseña</label>
                        <input type="password" id="password" name="password" class="input-prymary w-full" placeholder="Contraseña..." />
                    </div>

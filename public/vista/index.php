		...
		<div class="carousel relative shadow-2xl bg-white">
			<div class="carousel-inner relative overflow-hidden w-full">
				...
				<div class="carousel-item absolute opacity-0" style="height:50vh;">
					...
					<img class="bg-cover" src="<?php echo $valores[0] ?>" width="400px" alt="">
				...
				<div class="carousel-item absolute opacity-0" style="height:50vh;">
					<div class="flex justify-center h-full w-full  text-white text-5xl text-center">
						<img src="<?php echo $valores[1] ?>" alt="" width="400px">
					</div>
				</div>
				...
				<div class="carousel-item absolute opacity-0" style="height:50vh;">
					<div class="flex justify-center h-full w-full  text-white text-5xl text-center">
						<img src="<?php echo $valores[2] ?>" alt="" width="400px">
					</div>
				</div>
				<label for="carousel-2"
				...
				<div class="carousel-item absolute opacity-0" style="height:50vh;">
					<div class="flex justify-center h-full w-full  text-white text-5xl text-center">
						<img src="<?php echo $valores[3] ?>" alt="" width="400px">
					</div>
				</div>
				<label for="carousel-3"
				...
				<div class="carousel-item absolute opacity-0" style="height:50vh;">
					<div class="flex justify-center h-full w-full  text-white text-5xl text-center">
						<img src="<?php echo $valores[4] ?>" alt="" width="400px">
					</div>
				</div>
				<label for="carousel-4"
